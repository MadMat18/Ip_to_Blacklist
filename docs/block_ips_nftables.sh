...
nft add rule inet filter input ip saddr 59.95.79.172 drop
...
nft add rule inet filter input ip saddr 41.90.42.28 drop
nft add rule inet filter input ip saddr 106.51.151.72 drop
